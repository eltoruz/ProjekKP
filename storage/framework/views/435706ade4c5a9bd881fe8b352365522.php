<?php $__env->startSection('title', 'Admin — Pusdatin Kemendikdasmen'); ?>
    ...
    <aside class="w-64 bg-slate-800 flex-shrink-0 overflow-y-auto flex flex-col">
        ...
        <nav class="px-3 py-4 space-y-1 flex-1">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-indigo-500/20 text-white font-medium' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
            ...
            <div class="pt-3">
                ...
                <a href="<?php echo e(route('admin.kerjasama.index')); ?>"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?php echo e(request()->routeIs('admin.kerjasama.*') ? 'bg-indigo-500/20 text-white font-medium' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Daftar Kerja Sama
                </a>
                <a href="<?php echo e(route('admin.kerjasama.create')); ?>"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?php echo e(request()->routeIs('admin.kerjasama.create') ? 'bg-indigo-500/20 text-white font-medium' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/eltoruz/ProjekKP/resources/views/layouts/admin.blade.php ENDPATH**/ ?>