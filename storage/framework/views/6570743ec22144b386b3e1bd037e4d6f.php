    ...
    <aside class="w-64 bg-navy flex-shrink-0 overflow-y-auto flex flex-col">
        ...
        <nav class="px-3 py-4 space-y-1 flex-1">
            ...
            <div class="pt-3">
                ...
                <a href="<?php echo e(route('mitra.surat.index')); ?>"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?php echo e(request()->routeIs('mitra.surat.*') ? 'bg-primary/20 text-white font-medium' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
